...
const Main = () => {
    ...
    return(
        <div id="main">
            ...
            <div id="container">
                <Routes>
                    <Route exact path="/" element={<Posts allPosts={allPosts} setAllPosts={setAllPosts} getPosts={getPosts} isLoggedIn={isLoggedIn} sendMessageToID={sendMessageToID} setSendMessageToID={setSendMessageToID}/>}/>
                    ...
                    <Route path="/profile" element={<Profile username={username} isLoggedIn={isLoggedIn} sendMessageToID={sendMessageToID} setSendMessageToID={setSendMessageToID} getPosts={getPosts}/>}/>
                </Routes>
            </div>
